...
It allows us to create a block of reusable code that's easy to implement repeatedly. 
```
...
```
Return invokes a function, and console.log prints a message to the console to check the code. It helps the developer debug, and troubleshoot code.
```

**_What's the difference between defining and calling a function?_**

```
Defining a function tells us what to call a function, and calling a function runs the code. 
```
...
```
A string is used to enclose text in the code. 
```

**_Number_**

```
This is used to represent a number value in code. If I want my code to show 42, I would use the number data type. 
```
...
```
Used to make a list that may or may not consist of multiple data types. It stores objects globabally. 
```
